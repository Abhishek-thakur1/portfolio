...
function smoothScroll() {
  ...
  scrollable.style.transform = `translate3d(100, ${current}px, 50)`;
}

class EffectCanvas {
  constructor() {
    this.container = document.querySelector(".container");
    this.images = document.querySelector(".bg_image");
  ...
  onWindowResize() {
    ...
    this.camera.updateProjectionMatrix(); // Used to recalculate projection dimensions.
  ...
  createMeshItems() {
    ...
    // this.images.style.height = '100%'
    // this.images.style.width = 'auto'
    // this.images.style.position = 'absolute'
    // this.images.style.left = '50%'
    // this.images.style.right = '50%'
    // this.images.style.transform = "translate(-50%)";
    // this.images.style.backgroundPosition = "center center";
    // this.images.style.backgroundSize = "contain";
      let meshItem = new MeshItem(this.images, this.scene);
      this.meshItems.push(meshItem);
    // });
  }

  // Animate smoothscroll and meshes. Repeatedly called using request animation frame
  render() {
    smoothScroll();
...
class MeshItem {
  ...
  render() {
    // this function is repeatedly called for each instance in the above
    this.getDimensions();
    this.mesh.position.set(this.offset.x, this.offset.y, 0);
    this.mesh.scale.set(this.sizes.x, this.sizes.y, 1);
